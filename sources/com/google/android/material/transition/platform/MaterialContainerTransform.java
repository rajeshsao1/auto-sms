    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startBounds == null) {
            ...
            if (endBounds == null) {
                ...
                final TransitionDrawable transitionDrawable = new TransitionDrawable(getPathMotion(), startView2, startBounds, startShapeAppearanceModel2, getElevationOrDefault(this.startElevation, startView2), endView2, endBounds, endShapeAppearanceModel2, getElevationOrDefault(this.endElevation, endView2), this.containerColor, this.startContainerColor, this.endContainerColor, this.scrimColor, entering, this.elevationShadowEnabled, FadeModeEvaluators.get(this.fadeMode, entering2), FitModeEvaluators.get(this.fitMode, entering2, startBounds, endBounds), buildThresholdsGroup(entering2), this.drawDebugEnabled);
