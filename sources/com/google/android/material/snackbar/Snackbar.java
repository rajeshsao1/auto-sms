...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarContentStyleAttrs(parent.getContext()) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, parent, false);
