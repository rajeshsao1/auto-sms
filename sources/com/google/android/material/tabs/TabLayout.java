...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x0080:
            ...
            r7.setSelectedIndicatorColor(r1)
            ...
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01b5 }
            int r2 = r1.getDimensionPixelSize(r2, r6)     // Catch:{ all -> 0x01b5 }
            float r2 = (float) r2     // Catch:{ all -> 0x01b5 }
            r10.tabTextSize = r2     // Catch:{ all -> 0x01b5 }
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01b5 }
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r1, (int) r2)     // Catch:{ all -> 0x01b5 }
            r10.tabTextColors = r2     // Catch:{ all -> 0x01b5 }
            r1.recycle()
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i2 >= 0 && this.indicatorRight > i2) {
                Drawable selectedIndicator = DrawableCompat.wrap(TabLayout.this.tabSelectedIndicator != null ? TabLayout.this.tabSelectedIndicator : this.defaultSelectionIndicator).mutate();
