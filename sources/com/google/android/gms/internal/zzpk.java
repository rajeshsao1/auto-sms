...
public interface zzpk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpk {
        ...
        private static class C0040zza implements zzpk {
        ...
        public static zzpk asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpk)) ? new C0040zza(iBinder) : (zzpk) queryLocalInterface;
        }
