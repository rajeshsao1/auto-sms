...
public class zzh implements zzk {
    ...
    private static class zza implements GoogleApiClient.zza {
        ...
        public void zza(ConnectionResult connectionResult) {
            ...
            if (zzh != null) {
                zzx.zza(Looper.myLooper() == zzh.zzahj.zzagW.getLooper(), (Object) "onReportServiceBinding must be called on the GoogleApiClient handler thread");
                zzh.zzXG.lock();
                try {
                    if (zzh.zzbz(0)) {
    ...
    private void zzZ(boolean z) {
        zzrn zzrn = this.zzahs;
        if (zzrn != null) {
            if (zzrn.isConnected() && z) {
                this.zzahs.zzFG();
            }
    ...
    private void zzpx() {
        ...
        if (zzrn != null) {
            if (this.zzahx) {
                zzrn.zza(this.zzahw, this.zzahy);
            }
            zzZ(false);
        }
    ...
    public void begin() {
        ...
        if (this.zzahu) {
            ...
            zze zze2 = new zze();
            Api.zza<? extends zzrn, zzro> zza2 = this.zzagt;
            Context context = this.mContext;
            Looper looper = this.zzahj.zzagW.getLooper();
            com.google.android.gms.common.internal.zzf zzf2 = this.zzahz;
            this.zzahs = (zzrn) zza2.zza(context, looper, zzf2, zzf2.zzqy(), zze2, zze2);
        }
        this.zzahp = this.zzahj.zzahT.size();
