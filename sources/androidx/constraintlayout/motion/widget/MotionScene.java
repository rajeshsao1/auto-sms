...
public class MotionScene {
    ...
    private int getId(Context context, String idString) {
        ...
        if (idString.contains("/")) {
            id = context.getResources().getIdentifier(idString.substring(idString.indexOf(47) + 1), DBHelper.CONTACTS_COLUMN_ID, context.getPackageName());
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) {
        ...
        while (true) {
            ...
            if (hashCode != -1496482599) {
                if (hashCode == 3355 && name.equals(DBHelper.CONTACTS_COLUMN_ID)) {
                    c = 0;
                }
