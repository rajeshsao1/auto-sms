...
public final class MultiDex {
    ...
    private static void doInstallation(android.content.Context r9, java.io.File r10, java.io.File r11, java.lang.String r12, java.lang.String r13, boolean r14) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.reflect.InvocationTargetException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.ClassNotFoundException, java.lang.InstantiationException {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r0.contains(r10)     // Catch:{ all -> 0x00b5 }
            if (r1 == 0) goto L_0x000b
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
            return
        L_0x000b:
            r0.add(r10)     // Catch:{ all -> 0x00b5 }
            ...
            java.lang.String r2 = java.lang.System.getProperty(r2)     // Catch:{ all -> 0x00b5 }
            r3.append(r2)     // Catch:{ all -> 0x00b5 }
            java.lang.String r2 = "\""
            r3.append(r2)     // Catch:{ all -> 0x00b5 }
            java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x00b5 }
            android.util.Log.w(r1, r2)     // Catch:{ all -> 0x00b5 }
        L_0x0051:
            java.lang.ClassLoader r1 = r9.getClassLoader()     // Catch:{ RuntimeException -> 0x00ab }
            ...
            android.util.Log.e(r2, r3)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
            return
        L_0x0061:
            clearOldDexDir(r9)     // Catch:{ all -> 0x0065 }
            goto L_0x006d
        L_0x0065:
            r2 = move-exception
            ...
            android.util.Log.w(r3, r4, r2)     // Catch:{ all -> 0x00b5 }
        L_0x006d:
            java.io.File r2 = getDexDir(r9, r11, r12)     // Catch:{ all -> 0x00b5 }
            androidx.multidex.MultiDexExtractor r3 = new androidx.multidex.MultiDexExtractor     // Catch:{ all -> 0x00b5 }
            r3.<init>(r10, r2)     // Catch:{ all -> 0x00b5 }
            r4 = 0
            r5 = 0
            java.util.List r5 = r3.load(r9, r13, r5)     // Catch:{ all -> 0x00a2 }
            installSecondaryDexes(r1, r2, r5)     // Catch:{ IOException -> 0x0080 }
            goto L_0x0093
        L_0x0080:
            r6 = move-exception
            ...
            android.util.Log.w(r7, r8, r6)     // Catch:{ all -> 0x00a2 }
            r7 = 1
            java.util.List r7 = r3.load(r9, r13, r7)     // Catch:{ all -> 0x00a2 }
            r5 = r7
            installSecondaryDexes(r1, r2, r5)     // Catch:{ all -> 0x00a2 }
        L_0x0093:
        ...
        L_0x00ab:
            ...
            android.util.Log.w(r2, r3, r1)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b5 }
            return
        L_0x00b5:
            r1 = move-exception
